...
namespace Namezr.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250709043551_AddCannedCommentEntity")]
    partial class AddCannedCommentEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Namezr.Features.Questionnaires.Data.CannedCommentEntity", b =>
                {
                    ...
                    b.ToTable("CannedComments", (string)null);
                });
            ...
            modelBuilder.Entity("Namezr.Features.Questionnaires.Data.CannedCommentEntity", b =>
                {
                    b.HasOne("Namezr.Features.Identity.Data.ApplicationUser", "Creator")
                        .WithMany()
                        .HasForeignKey("CreatorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
